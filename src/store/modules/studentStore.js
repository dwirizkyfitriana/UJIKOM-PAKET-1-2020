  ...
  actions: {
    ...
    addStudent: async function(context, payload) {
      return new Promise((resolve, reject) => {
        ...
        query.save({...payload, 
          major: {__type: 'Pointer', className: 'Majors', objectId: payload.major},
          class: {__type: 'Pointer', className: 'Classes', objectId: payload.class},
          schoolYears: {__type: 'Pointer', className: 'schoolYears', objectId: payload.schoolYears}
        }).then(res => {
          res = JSON.parse(JSON.stringify(res))
          console.log('new', res)
    ...
    updateStudent: async function(context, payload) {
      return new Promise((resolve, reject) => {
        ...
        context.dispatch('fetchStudentById', payload.objectId).then(res => {
          res.save({...payload, 
            major: {__type: 'Pointer', className: 'Majors', objectId: payload.major},
            class: {__type: 'Pointer', className: 'Classes', objectId: payload.class},
            schoolYears: {__type: 'Pointer', className: 'schoolYears', objectId: payload.schoolYears}
    ...
    deleteStudent: async function(context, payload) {
      return new Promise((resolve, reject) => {
        ...
        context.dispatch('fetchStudentById', payload).then(res => {
